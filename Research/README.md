...
| `04-直接NN参数估计/` | 直接神经估计的条件优势、训练域依赖与失效边界 | `ACTIVE` | `INDEPENDENT` | 同协议参照和训练域设计实验已完成；正文及附录 v0.2 收口修订，以同中心扩宽为主证据，机制归因保留替代解释；回退规则不作为完成条件，区间评价后置 |
...
- **Study01 Direct-MLP/P3/P4 对照**
  - 旧 P4 生成产物已于 2026-09-07 退出活动目录，试错结论与恢复说明见 [Study01 认识快照](../Study/01-study-MDM最小偏移量优化研究/archive/07-认识清单与研究快照-20260907.md)。Research04 当前独立证据保持原位；Study01 当前实验以 [配置文档](../Study/01-study-MDM最小偏移量优化研究/02-实验配置.md)为准。
