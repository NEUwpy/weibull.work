...
2. 30次迭代
3. 15次迭代
4. 离散搜索 (间隔100，从1430开始)

输出:
- public/case-studies/mdm/case7/data.json
"""
...
def main():
    ...
    # 保存结果 - 使用绝对路径
    # 脚本在 python/mdm/case_studies/case7/，需要走4级到项目根目录
    script_dir = os.path.dirname(os.path.abspath(__file__))
    project_root = os.path.normpath(os.path.join(script_dir, "..", "..", "..", ".."))
    output_path = os.path.join(project_root, "public", "case-studies", "mdm", "case7", "data.json")
