...
输出:
- public/case-studies/mdm/case16/data.json
"""
...
def main():
    print("=" * 70)
    print("案例16: MDM vs WMLE 方法对比研究 (精细步长 + 多尺度参数)")
    ...
    output_path = os.path.join(project_root, "public", "case-studies", "mdm", "case16", "data.json")
    print(f"\n输出路径: {output_path}")
