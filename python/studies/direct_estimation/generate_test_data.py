...
参数空间（V2 训练集）：
    β∈{0.5,1,2,3,5}, η∈{100,500,1000,3000,5000}, γ∈{0,50,100,200}, n∈{5,7,10,15}

插值参数（训练点之间的值）：
    β_ip∈{0.75,1.5,2.5,4}, η_ip∈{300,750,2000,4000}, γ_ip∈{25,75,150}

外推参数（超出训练范围）：
    β_ex∈{0.3,8,10}, η_ex∈{50,8000,10000}, γ_ex∈{-50,300,500}
...
TRAIN_GAMMAS = [0.0, 50.0, 100.0, 200.0]
TRAIN_NS = [5, 7, 10, 15]
