...
2. **Methods (方法系统)** - 8 大类 22 种参数估计方法的详细文档与可视化（11 个有后端实现）
3. **Case Database (案例库)** - 科研文献中的标准失效数据集
4. **Library (图书馆)** - Markdown 文献阅读
5. **AI Methods (人工智能方法)** - AI 辅助参数估计：M1 关系建立（待开发）、M3 直接估计（原型）、M2 优化求解（待开发）
...
| `06-模块.md` | 需要了解系统功能 | 系统模块定义（六大模块）、各 Tab 目的与功能 |
