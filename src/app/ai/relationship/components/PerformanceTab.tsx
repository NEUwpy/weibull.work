 ...
 * 性能展示 Tab
 *
 * 图表：P1(预测vs真实散点图), P2(误差分布直方图), P3(热力图), P4(指标对比), P5(预测vs真实分布)
 */
"use client"
          ...
          return (
            <React.Fragment key={n}>
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                ...
                <div className="text-lg font-black text-purple-700 font-mono">{mse.toFixed(6)}</div>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="text-xs text-blue-500">n={n} MAE</div>
                <div className="text-lg font-black text-blue-700 font-mono">{mae.toFixed(6)}</div>
              </div>
            </React.Fragment>
          )
        })}
