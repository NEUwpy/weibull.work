...
import { ArrowLeft, GitBranch, BookOpen, Cpu, Database, RefreshCw, Crosshair, Target, Play, FlaskConical, GitCompare } from 'lucide-react'
...
const tabs = [
  ...
  { id: 'iteration', label: '迭代过程', icon: RefreshCw },
...
export default function M1R2Page() {
    ...
    <section className="w-full max-w-[95%] xl:max-w-[1800px] mx-auto pl-[4.5rem] pr-[4rem] py-8 space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-slate-900">M1-R2 迭代逼近</h1>
            <p className="text-sm text-slate-500 font-medium">从 δ₀=0.5 开始，MDM 估计参数，网络预测新 δ，迭代直到收敛</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="p-6 min-h-[400px]">
          ...
          {activeTab === 'iteration' && <IterationTab />}
