...
LABELS.update({'200/200 检查点可行':'200/200 feasible checkpoints', 'A  较宽可靠度范围':'A  Wider reliability range', 'A  有符号误差分布':'A  Signed error distribution', 'B  绝对误差的超越比例':'B  Absolute-error exceedance', 'C  高估与低估的再分配':'C  Over- and underestimation'})
