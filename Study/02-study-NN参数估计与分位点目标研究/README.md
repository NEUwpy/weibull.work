...
在项目级分类中，前置研究 A 为 `COMPLETE + EMBEDDED` Research：当前入口仍是本目录的 `06-A-前置研究报告.md`，代码、formal artifacts、manifest 和历史 SHA 全部保持原位；项目根 `../../Research/04-直接NN参数估计/README.md` 只建立索引，不复制或重封证据。
