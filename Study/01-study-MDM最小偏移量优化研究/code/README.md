...
> 复现入口以[实验配置](../02-实验配置.md)为准，待做工作见[计划](../04-后续实验计划.md)。本目录旧审计/图形合同仅用于追溯。
...
旧 E3/E4/P2/P3/P4、旧图形程序仍有少量函数被当前代码复用，保留文件不表示路线继续。旧生成数据已清理，恢复说明见[认识快照](../archive/07-认识清单与研究快照-20260907.md)。不要按旧 docstring 的“最终方法”字样覆盖当前配置。
