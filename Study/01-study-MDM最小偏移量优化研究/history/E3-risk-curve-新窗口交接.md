...
> 历史归档说明（2026-07-09）：本文件记录 E3a 启动前的 risk-curve 合同讨论。E3a/E3b 现已完成并封存，当前状态以 `README.md`、`01-证据索引.md`、`02-实验协议.md`、`03-论文骨架.md`、`05-投稿进度控制.md` 和 `draft-Ch6-初稿.md` 为准。不要再按本文的“E3a 尚未跑 / Ch6 尚未写结论”状态派活。
