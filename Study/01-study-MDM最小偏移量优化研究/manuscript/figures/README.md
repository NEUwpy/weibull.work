...
当前正文 v1.12 使用七张图，附录 v1.10 使用九张图；另有两张复核图。当前稿件图号与稳定资产文件名的对应以 [figure-index.md](figure-index.md) 和 `figure_sources.json` 为准。`main/` 与 `supplementary/` 是资产存储位置，不单独决定稿件归属。
