...
| Dimensional-RAW 主结果 | `Study/01-study-MDM最小偏移量优化研究/artifacts/formal/E6_dimensional_raw/specialist/` | 图 1 方法配置依据、图 3、表 1–2、随机种子图 |
| 未见 beta 验证 | `.../E6_dimensional_raw/unseen_beta/` | 支撑验证表、未见 beta 图表 |
| 传统方法参照 | `.../E6_dimensional_raw/traditional_ref/` | WMLE/LSE 图表 |
| 工程分位点 | `.../E6_dimensional_raw/quantiles/` | x0.90/x0.95/x0.99 图表 |
