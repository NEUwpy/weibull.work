...
| `fig3_per_n_J1.png` | 均值归一化 MLP / Default / L6 按 n 的 J1 | E8 `specialist/summary.json` |
| `table1_l1_l6.md` | L1–L6 规则/协议/结果 | E8 `specialist/crossfit_layers.csv` |
| `table2_main_results.md` | 主方法比较 | E8 `specialist/summary.json` |
...
| `supp_fig_unseen_beta.png` | 未见 β 留出验证 | E8 `unseen_beta/summary.json` |
| `supp_fig_traditional_per_n.png` | 传统方法参照按 n | E6 `traditional_ref/summary.csv` + E8 |
| `supp_fig_quantile_rmse.png` | 分位点相对 RMSE | E8 `quantiles/summary.csv` |
...
```bash
python manuscript/figures/scripts/build_figures.py
```
