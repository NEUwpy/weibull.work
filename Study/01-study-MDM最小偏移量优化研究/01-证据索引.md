...
| C13 | seed 42 下，样本自适应方法在四个样本量下分别取得 Default—L6 差距的 40.0%、35.4%、26.8% 和 24.7% | `artifacts/formal/E8_mean_normalized_selector/seed42_primary/main_results.csv` | 可写；仅指当前 26 点候选网格内、相同测试样本上的差距，不是理论最优比例 |
