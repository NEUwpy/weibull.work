...
| C5 | 固定随机种子 42 的 Mean-Normalized-MLP 相对 Default 将 pooled $J_1$ 改善 7.2740% | `artifacts/formal/E8_mean_normalized_selector/seed42_primary/summary.json`、`main_results.csv` | 可写；同测试样本、当前离散设计 |
