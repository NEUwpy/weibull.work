...
结论：**在本文正式设计网格的等权 pooled 口径下，全局常数 δ 和按 n 查表均无法系统性地超越经验值 0.1。** L1 相对 Default、L2 相对 L1 的 pooled $J_1$ 降幅分别为 0.048% 和 0.059%，均低于按 $\beta$ 分组所见的 0.77%–8.11% 变化。原文的 0.1 因而是该设计测度下的强基线，但这不等于已证明其对任意真实参数分布都近似最优；第 5 章继续检验更高信息层级，尤其 $\beta$ 异质性所对应的改进空间。
