...
全局 J₁ 的近乎相等掩盖了一个重要的分参数现象。**图 3**(b) 将 δ-risk 曲线按 β 分解，Table 2 则从 L1 vs Default 的角度量化了这种结构差异：β = 1.5 时 L1 反而恶化 1%–8%，β = 4.0–5.0 时 L1 稳定改善约 2%–4%。完整 45 组合见 `table_default_vs_L1.csv`。
