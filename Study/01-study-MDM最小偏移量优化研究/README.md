...
Formal E4 消融、边界与稳健性
  -> E4a 正式特征组消融已完成；E4b/E4c 已形成 boundary/off-grid reference landscape；E4d selector 外推、E3c 连续空间训练与真实数据外部验证未完成
```
...
| `01-证据索引.md` | 区分文献证据、pilot 证据和正式证据；Formal E1/E2、E3 existing-grid、E4a 与 E4b/E4c reference-only 已可用，E4d/E3c 未启动 |
